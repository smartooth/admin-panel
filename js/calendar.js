...
var targetDate = new Date(2014, 2, 18);
var jfcalplugin;
...
$(document).ready(function() {
	...
	function myApplyTooltip(divElm,agendaItem){
		...
		var displayData = "<span style=\"font-size: 0.7em;\">";
	 ...
	 */
	jfcalplugin.setAspectRatio("#cal",.75);
	 ...
	 */
	$("#dateSelect").datepicker('setDate', targetDate);
	/**
	...
	$("#BtnICalTest").click(function() {
		...
		jfcalplugin.loadICalSource("#cal",$("#iCalSource").val(),"html");	
		return false;
	});*/	
			...
			'Delete': function() {
				if(confirm("Are you sure you want to delete this agenda item?")){
					if(clickAgendaItem != null){
						...
						//jfcalplugin.deleteAgendaItemByDataAttr("#cal","myNum",42);
					}
					$(this).dialog('close');
				}
			}*/
		...
		open: function(event, ui){
			if(clickAgendaItem != null){
				...
				if(allDay){
					...
					$("#display-event-form").append(
						"<b>Starts:</b> " + $.format.date(startDate, "MMMM d, yyyy HH:mm:ss") + "<br>" +
						"<b>Ends:</b> " + $.format.date(endDate, "MMMM d, yyyy HH:mm:ss") + "<br><br>"				
					);				
				}
				for (var propertyName in data) {
